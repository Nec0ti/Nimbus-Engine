...
namespace NimbusEditor.GameProject
{
    ...
    {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\NimbusEditor\";
        ...
        private static void ReadProjectData()
        {
            if(File.Exists(_projectDataPath))
            {
                ...
                foreach (var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.Nimbus\Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.Nimbus\Screenshot.png");
